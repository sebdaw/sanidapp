<?php
class BlocksController extends ViewController {
    protected static ?int $id_section = 3;
    protected const FOLDER = 'blocks/';
    ...
    public static function main(){
        ...
        if (is_null($action)){
            static::showView(static::FOLDER . 'blocks-view.php');
            die;
        }
        ...
        case DEL:
            ...
            if (static::deleteBlock($data)){
                http_response_code(200);
                $json = json_encode(['msg'=>'Bloque eliminado con éxito'],flags:JSON_UNESCAPED_UNICODE);
            }else{
                http_response_code(500);
                $json = json_encode(['msg'=>'Ha ocurrido un error intentando eliminar el bloque'],flags:JSON_UNESCAPED_UNICODE);
            }
            echo $json;
            break;
        case ORD:
    ...
    public static function table() {
        ...
        if (is_null($user) || !static::hasAccessPermission($user->getId())){
            ...
            static::showView(static::FOLDER . 'blocks-table.php');
        }
    }
    ...
    public static function form() {
        ...
        case INS:
            ...
            if (!is_null(static::newBlock($data))){
                http_response_code(200);
    ...
    protected static function newBlock(mixed $data) : ?int {
    ...
    protected static function editBlock(mixed $data) : bool {
    ...
    protected static function deleteBlock(mixed $data) : bool {
